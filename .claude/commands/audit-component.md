...
- `--deep` — also runs [`stencil-compliance`](../skills/stencil-compliance/SKILL.md)'s [Run contract](../skills/stencil-compliance/SKILL.md#run-contract) and invokes `/audit-accessibility` for full WCAG 2.1 AA deep audit. Adds ~30s.
