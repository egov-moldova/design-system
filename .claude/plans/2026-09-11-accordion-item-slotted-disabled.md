...
| 19 | Everything written is released when the item leaves the document | `disconnectedCallback` calls `releaseSlottedWrites`; `src/components/AGENTS.md:93` acquire/release symmetry. NOT covered by a test — see § Not Verified |
