...
| `superpowers:verification-before-completion` | Evidence-based completion gates. No "Done!" without verified output. | No | From the globally-installed `superpowers` plugin (see Prerequisite below) — reference from `/pre-pr-check`, `/new-component` Step 9 |
