...
**Conformance target for `@egov-moldova/mud`:** **WCAG 2.1 Level AA**.
...
**Note:** The `@egov-moldova/mud` has documented exceptions where `button` sm/xs and `checkbox` sm/md are below 24×24 visually but maintain adequate spacing. See [`src/components/_agents/target-size-exceptions.md`](../../../../src/components/_agents/target-size-exceptions.md).
