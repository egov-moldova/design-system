...
|---|---|---|
| Component framework | StencilJS | see `STACK.md` |
| Language | TypeScript | see `STACK.md` |
| Documentation / visual testing | Storybook (`@storybook/web-components-vite`) | see `STACK.md`; port **6007** |
| Token pipeline | Style Dictionary (DTCG `$value` / `$type`) | see `STACK.md` |
| Build orchestration | Wireit | see `STACK.md` |
| Unit + E2E tests | Vitest (with `@stencil/vitest`) | see `STACK.md` |
| Package manager | Yarn | see `STACK.md` |
| Node | Node | see `STACK.md` |
