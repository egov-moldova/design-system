...
These three documents describe what `@egov-moldova/mud` is, how its design tokens are organized, and how components are built. They are the **onboarding-level reference** — concise enough to read end-to-end, deep enough to anchor decisions.
