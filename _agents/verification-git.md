...
generated files (`src/components.d.ts`, component/hidden `readme.md`) are regenerated by
`yarn build` and committed together with the source change that regenerated them, never
hand-edited or staged separately. `.storybook/custom-elements.json` and `tokens/generated/**`
