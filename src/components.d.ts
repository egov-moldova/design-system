...
export namespace Components {
    ...
    interface MudAccordionItem {
        ...
        /**
          * Layout breakpoint (desktop ≥ 768px, mobile below). Owned by the parent `mud-accordion`, which assigns it on load and on every viewport crossing — setting it on an item is overwritten. Configure it on the parent instead.
          * @default 'desktop'
         */
        "breakpoint": 'desktop' | 'mobile';
        /**
    ...
    interface MudDateInput {
        ...
        "label"?: string;
        /**
          * Locale of the built-in labels and error messages, and of the calendar's month and weekday names, which `mud-date-picker` takes from `Intl`. The typed value itself follows `format`, not the locale.
         */
