...
| `supportingText` | `supporting-text` | Plain-text supporting text shown below the label. Use the `supporting-text` slot for richer content.                                                                                  | `string \| undefined` | `undefined` |
