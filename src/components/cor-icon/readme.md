...
| `color`       | `color`       | Icon color.  You can either: - Pass a design-token suffix that maps to a CSS variable (e.g. `color="neutral-icon-weak"` -> `var(--color-neutral-icon-weak)`), or - Pass `color="currentColor"` to inherit the text color from the parent element. | `string`                                                                                                                          | `'primary-icon-default'` |
