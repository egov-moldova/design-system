...
import type { InputChipSize, InputChipVariant } from './cor-input-chip.types';
...
const docsSourceDefault = (args: InputChipArgs) => {
  const attrs = [
    ...
    .filter(Boolean)
    .join(' ');
  return `<cor-input-chip ${attrs}></cor-input-chip>`;
};
    ...
    wrap(
      INPUT_CHIP_VARIANTS.map((variant, i) => {
        ...
        return cell(
          variant,
          /*html*/ `
            <cor-input-chip id="${id}" variant="${variant}" size="lg" label="Destinatari" placeholder="Adaugă adresă"></cor-input-chip>
    ...
    wrap(
      INPUT_CHIP_SIZES.map((size, i) => {
        ...
        return cell(
          size,
          /*html*/ `
            <cor-input-chip id="${id}" size="${size}" label="Destinatari" placeholder="Adaugă adresă"></cor-input-chip>
            ${preloadChips(`#${id}`, ['ana@gov.md', 'ion@gov.md'])}
          `,
        );
      }).join(''),
  ...
  render: () =>
    wrap(
      [
        cell(
          'default (empty)',
          /*html*/ `<cor-input-chip size="lg" label="Destinatari" placeholder="Adaugă adresă"></cor-input-chip>`,
        ),
        (() => {
          ...
          return cell(
            'filled (3 chips)',
            /*html*/ `
              <cor-input-chip id="${id}" size="lg" label="Destinatari" placeholder="Adaugă altă adresă"></cor-input-chip>
        ...
        cell(
          'mandatory',
          /*html*/ `<cor-input-chip size="lg" label="Destinatari" required placeholder="Câmp obligatoriu"></cor-input-chip>`,
        ),
        cell(
          'disabled',
          /*html*/ `<cor-input-chip size="lg" label="Destinatari" disabled placeholder="Adaugă adresă"></cor-input-chip>`,
        ),
        (() => {
          ...
          return cell(
            'disabled (with chips)',
            /*html*/ `
              <cor-input-chip id="${id}" size="lg" label="Destinatari" disabled></cor-input-chip>
              ${preloadChips(`#${id}`, ['ana@gov.md', 'ion@gov.md'])}
            `,
          );
        })(),
        cell(
          'destructive',
          /*html*/ `<cor-input-chip variant="destructive" size="lg" label="Destinatari" placeholder="Adaugă adresă"></cor-input-chip>`,
        ),
      ].join(''),
    ),
  parameters: { controls: { disable: true } },
      ...
      [
        (() => {
          ...
          return cell(
            ...
            /*html*/ `
              <cor-input-chip id="${id}" size="lg" label="Etichetă lungă" placeholder="Adaugă altă valoare"></cor-input-chip>
