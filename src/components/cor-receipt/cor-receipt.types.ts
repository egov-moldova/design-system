 ...
 * Maps to a `cor-tag` semantic + Romanian label inside the component:
...
/** Payload emitted by the four action events (`corDownload`, `corShare`, `corEmail`, `corPrint`). */
