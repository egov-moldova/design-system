...
| `ariaLabel`          | `aria-label`           | Override for the receipt's accessible name. Defaults to the resolved title plus status (e.g. "Bon de plată — Plătit").                                                                                                                                                                                                                                                    | `string \| undefined`                                         | `undefined` |
