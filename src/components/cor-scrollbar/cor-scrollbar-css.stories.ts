...
export const VerticalCSS = {
  ...
  render: (args: Partial<ScrollbarArgs>) => {
    ...
    return /*html*/ `
      <div class="cor-overflow-scrollbar${variantClass}" style="overflow: auto; height: 240px; width: 100%; border: 1px solid var(--color-border-base-subtle);">
...
export const HorizontalCSS = {
  ...
  render: (args: Partial<ScrollbarArgs>) => {
    ...
    const items = Array.from(
      { length: 40 },
      () =>
        /*html*/ `<div style="height: 100%; width: 50px; margin-right: 8px; background: var(--color-background-base-default); border-radius: 8px;"></div>`,
    ).join('');

    return /*html*/ `
      <div class="cor-overflow-scrollbar${variantClass}" style="overflow: auto; height: 240px; width: 100%; border: 1px solid var(--color-border-base-subtle); padding: 16px;">
...
export const BothCSS = {
  ...
  render: (args: Partial<ScrollbarArgs>) => {
    ...
    return /*html*/ `
      <div class="cor-overflow-scrollbar${variantClass}" style="overflow: auto; height: 300px; width: 100%; border: 1px solid var(--color-border-base-subtle);">
