...
import type { TabDescriptor, TabsSize } from './cor-tabs.types';
...
const meta: Meta<StoryArgs> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '`cor-tabs` is a horizontal tablist following the WAI-ARIA tabs pattern. ' +
          'It supports two composition modes: declarative `<cor-tab>` children, or a ' +
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      source: {
        code: `<cor-tabs aria-label="Navigare cont" value="profil"></cor-tabs>
<script>
  document.querySelector('cor-tabs').tabs = [
    { value: 'profil', label: 'Profil' },
    { value: 'documente', label: 'Documente' },
    { value: 'notificari', label: 'Notificări' },
    { value: 'setari', label: 'Setări' },
        ...
        cell(
          ...
          /*html*/ `
            <div style="inline-size: 420px;">
              <cor-tabs id="tabs-of-mid" aria-label="Overflow leading" value="setari"></cor-tabs>
            </div>
...
export const WithPanels: Story = {
  ...
  render: () => /*html*/ `
    <div style="padding: var(--spacing-24); max-width: 720px;">
      <cor-tabs id="tabs-panels" aria-label="Cont utilizator" value="profil">
        <cor-tab value="profil" label="Profil"></cor-tab>
        <cor-tab value="documente" label="Documente"></cor-tab>
        <cor-tab value="notificari" label="Notificări"></cor-tab>
        <cor-tab value="setari" label="Setări"></cor-tab>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Declarative composition: `<cor-tab>` children alongside matching ' +
    ...
    wrap(
      [
        ...
        cell(
          ...
          /*html*/ `
            <cor-tabs aria-label="Listă goală"></cor-tabs>
          `,
        ),
      ].join(''),
    ),
