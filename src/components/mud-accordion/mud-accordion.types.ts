/**
 * Coordination mode for child `mud-accordion-item` elements.
 ...
 * `items` prop instead of slotting `<mud-accordion-item>` children.
 */
export type AccordionItemDescriptor = {
  /** Stable identifier used by `mudChange.openIds`. Auto-generated if omitted. */
  id?: string;
  /** Header text. */
  heading: string;
  /** Secondary text below the heading. */
  supportingText?: string;
  /** Panel body text. For rich content, slot `<mud-accordion-item>` children instead. */
  content?: string;
...
/**
 * Payload dispatched by `mudChange` whenever the open set changes.
