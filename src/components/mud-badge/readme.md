...
| `disabled` | `disabled` | Renders the disabled design, replacing the `variant` colors. Visual only — `aria-disabled` is not supported on `role="status"`, so the disabled state is announced by the container that owns the badge.                                                                                                                                                                                | `boolean`                                                     | `false`      |
