...
import { PAGINATION_SIZES } from './mud-pagination.types';
import type { PaginationSize } from './mud-pagination.types';
...
const docsSourceDefault = (args: PaginationArgs) => {
  const attrs = [
    ...
    .filter(Boolean)
    .join(' ');
  return `<mud-pagination ${attrs}></mud-pagination>`;
};
...
export const WithoutPrevNext: Story = {
  ...
  parameters: {
    ...
    docs: {
      source: {
        code: `<mud-pagination current-page="3" total-pages="7" show-prev-next="false"></mud-pagination>`,
      },
    },
  },
};
...
export const Disabled: Story = {
  render: () => /*html*/ `
    <div style="display: flex; flex-direction: column; gap: var(--spacing-16); padding: var(--spacing-24); max-width: 540px;">
      ...
      <div style="border: 1px dashed var(--color-border-base-default); padding: var(--spacing-12); border-radius: var(--border-radius-6);">
        <mud-pagination current-page="1" total-pages="1"></mud-pagination>
  ...
  parameters: {
    ...
    docs: {
      source: {
        code: `<mud-pagination current-page="1" total-pages="1"></mud-pagination>`,
      },
    },
  },
};
  ...
  render: () => /*html*/ `
    <div style="display: flex; flex-direction: column; gap: var(--spacing-16); padding: var(--spacing-24); max-width: 720px;">
      <p style="font-size: var(--font-size-14); color: var(--color-text-base-default); margin: 0;">
        ...
        Picking a page emits <code>mudChange</code> just like the numbered buttons.
