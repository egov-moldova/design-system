...
import '../mud-search-input-rectangular';
...
describe('mud-search-input-rectangular', () => {
  describe('defaults + prop reflection', () => {
    it('renders with default props reflected on host', async () => {
      const { root } = await render(<mud-search-input-rectangular></mud-search-input-rectangular>);
    ...
    it.each(SEARCH_INPUT_RECTANGULAR_VARIANTS)('reflects variant="%s" to host', async variant => {
      const { root } = await render(<mud-search-input-rectangular variant={variant}></mud-search-input-rectangular>);
      expect(root?.getAttribute('variant')).toBe(variant);
    });

    it.each(SEARCH_INPUT_RECTANGULAR_SIZES)('reflects size="%s" to host', async size => {
      const { root } = await render(<mud-search-input-rectangular size={size}></mud-search-input-rectangular>);
  ...
  describe('shadow structure', () => {
    it('renders the label via the `label` prop', async () => {
      const { root } = await render(<mud-search-input-rectangular label="Căutare"></mud-search-input-rectangular>);
      const label = queryLabel(root);
      expect(label?.textContent).toContain('Căutare');
    });

    it('adds a required mark when `required` is set', async () => {
      const { root } = await render(<mud-search-input-rectangular label="x" required></mud-search-input-rectangular>);
    ...
    it('respects the iconName prop on the default leading icon', async () => {
      const { root } = await render(<mud-search-input-rectangular icon-name="filter"></mud-search-input-rectangular>);
      const icon = root?.shadowRoot?.querySelector('.control-icon-start mud-icon');
    ...
    it('renders a helper assistive row when `helper-text` is set', async () => {
      const { root } = await render(
        <mud-search-input-rectangular label="x" helper-text="hint"></mud-search-input-rectangular>,
      );
    ...
    it('renders an error assistive row with the error icon when invalid + error-text', async () => {
      const { root } = await render(
        <mud-search-input-rectangular label="x" invalid error-text="Required"></mud-search-input-rectangular>,
      );
      const assistive = queryAssistive(root);
  ...
  describe('clear button visibility', () => {
    ...
    it('shows the clear button when value is non-empty', async () => {
      const { root } = await render(<mud-search-input-rectangular value="hello"></mud-search-input-rectangular>);
    ...
    it('uses the custom clearLabel for aria-label', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello" clear-label="Clear"></mud-search-input-rectangular>,
      );
    ...
    it('hides the clear button when clearable=false', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello" clearable={false}></mud-search-input-rectangular>,
      );
      expect(queryClearButton(root)).toBeNull();
    });
    ...
    it('hides the clear button when disabled', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello" disabled></mud-search-input-rectangular>,
      );
      expect(queryClearButton(root)).toBeNull();
    });
    ...
    it('hides the clear button when readonly', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello" readonly></mud-search-input-rectangular>,
      );
      expect(queryClearButton(root)).toBeNull();
    });
  });
  ...
  describe('value + form association', () => {
    ...
    it('emits mudInput on each keystroke', async () => {
      const onInput = vi.fn();
      const { root } = await render(<mud-search-input-rectangular onMudInput={onInput}></mud-search-input-rectangular>);
      const native = queryNative(root)!;
      native.value = 'a';
    ...
    it('emits mudChange on change (blur commit)', async () => {
      ...
      const { root } = await render(
        <mud-search-input-rectangular onMudChange={onChange}></mud-search-input-rectangular>,
      );
      const native = queryNative(root)!;
      native.value = 'done';
    ...
    it('emits mudFocus and mudBlur and toggles the is-focused class', async () => {
      ...
      const onBlur = vi.fn();
      const { root } = await render(
        <mud-search-input-rectangular onMudFocus={onFocus} onMudBlur={onBlur}></mud-search-input-rectangular>,
      );
      const native = queryNative(root)!;
  ...
  describe('keyboard contract', () => {
    ...
    it('emits mudSearch on Enter with the current value', async () => {
      ...
      const { root } = await render(
        <mud-search-input-rectangular value="hello" onMudSearch={onSearch}></mud-search-input-rectangular>,
      );
      press(root, 'Enter');
      await flush();
    ...
    it('Escape with empty value does not emit mudClear', async () => {
      const onClear = vi.fn();
      const { root } = await render(<mud-search-input-rectangular onMudClear={onClear}></mud-search-input-rectangular>);
      press(root, 'Escape');
      await flush();
    ...
    it('Escape on disabled input does not clear', async () => {
      const onClear = vi.fn();
      const { root } = await render(
        <mud-search-input-rectangular value="hello" disabled onMudClear={onClear}></mud-search-input-rectangular>,
      );
      press(root, 'Escape');
      await flush();
      expect(onClear).not.toHaveBeenCalled();
  ...
  describe('disabled + readonly behavior', () => {
    it('passes disabled through to the native input', async () => {
      const { root } = await render(<mud-search-input-rectangular disabled></mud-search-input-rectangular>);
      const native = queryNative(root);
    ...
    it('passes readonly through to the native input', async () => {
      const { root } = await render(<mud-search-input-rectangular readonly value="x"></mud-search-input-rectangular>);
      const native = queryNative(root);
  ...
  describe('ARIA contract', () => {
    ...
    it('uses aria-label as the accessible name when no visible label is present', async () => {
      const { root } = await render(<mud-search-input-rectangular aria-label="Caută"></mud-search-input-rectangular>);
      const native = queryNative(root);
    ...
    it('exposes aria-invalid when invalid', async () => {
      const { root } = await render(<mud-search-input-rectangular invalid></mud-search-input-rectangular>);
  ...
  describe('slots', () => {
    it('forwards content into the icon-end slot', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello">
  ...
  describe('loading state', () => {
    it('reflects loading to the host attribute', async () => {
      const { root } = await render(<mud-search-input-rectangular loading></mud-search-input-rectangular>);
    ...
    it('uses spinner size "md" on size="lg" and "sm" on size="md"', async () => {
      const { root: lg } = await render(
        <mud-search-input-rectangular size="lg" loading></mud-search-input-rectangular>,
      );
      expect(querySpinner(lg)?.getAttribute('size')).toBe('md');
      const { root: md } = await render(
        <mud-search-input-rectangular size="md" loading></mud-search-input-rectangular>,
      );
    ...
    it('suppresses the clear button while loading (Figma master 933:29133)', async () => {
      const { root } = await render(
        <mud-search-input-rectangular value="hello" loading></mud-search-input-rectangular>,
      );
      expect(queryClearButton(root)).toBeNull();
    });
  });
  ...
  describe('with-button (submit affordance)', () => {
    it('reflects withButton via the `with-button` attribute', async () => {
      const { root } = await render(<mud-search-input-rectangular with-button></mud-search-input-rectangular>);
    ...
    it('uses the custom submitLabel for aria-label', async () => {
      const { root } = await render(
        <mud-search-input-rectangular with-button submit-label="Search"></mud-search-input-rectangular>,
      );
    ...
    it('the submit button is enabled when the value is non-empty', async () => {
      const { root } = await render(
        <mud-search-input-rectangular with-button value="hello"></mud-search-input-rectangular>,
      );
      const button = querySubmitButton(root)!;
    ...
    it('the submit button is disabled when the host is disabled', async () => {
      const { root } = await render(
        <mud-search-input-rectangular with-button value="hello" disabled></mud-search-input-rectangular>,
      );
    ...
    it('the submit button is disabled when the host is readonly', async () => {
      const { root } = await render(
        <mud-search-input-rectangular with-button value="hello" readonly></mud-search-input-rectangular>,
      );
      expect(querySubmitButton(root)?.hasAttribute('disabled')).toBe(true);
    });
    ...
    it('emits mudSearch on submit-button click with the current value', async () => {
      const onSearch = vi.fn();
      const { root } = await render(
        <mud-search-input-rectangular with-button value="hello" onMudSearch={onSearch}></mud-search-input-rectangular>,
      );
    ...
    it('does not emit mudSearch when the submit-button click target is disabled', async () => {
    ...
    it('coexists with the loading spinner when both are set', async () => {
      const { root } = await render(
        <mud-search-input-rectangular with-button value="hello" loading></mud-search-input-rectangular>,
      );
      expect(querySpinner(root)).toBeTruthy();
      expect(querySubmitButton(root)).toBeTruthy();
    });
  ...
  describe('form validity', () => {
    ...
    it('sets valueMissing on transition from filled to empty when required', async () => {
      const { root } = await render(
        <mud-search-input-rectangular label="x" required value="query"></mud-search-input-rectangular>,
      );
    ...
    it('re-syncs validity when required toggles', async () => {
      const { root } = await render(<mud-search-input-rectangular label="x"></mud-search-input-rectangular>);
      const internals = (root as unknown as InstanceWithInternals).internals;
      const spy = vi.spyOn(internals, 'setValidity');
