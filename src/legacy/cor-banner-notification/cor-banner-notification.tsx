 ...
 * @slot title      - Heading text (keep concise — single line preferred).
 ...
 */
@Component({
  tag: 'cor-banner-notification',
  styleUrl: 'cor-banner-notification.css',
  shadow: true,
})
export class CorBannerNotification {
  ...
  @Element() host!: HTMLCorBannerNotificationElement;
      ...
      >
        ...
        <div class="content-wrapper">
          <div class="icon-area" aria-hidden="true">
            ...
            />
            {!this.hasIconSlot && (
              <cor-icon name={ICON_NAMES.WARNING__FILLED} color="currentColor" size={IconSize.MD} />
            )}
          </div>
